import 'dart:convert';
import 'package:dpc_flutter/Pages/Scanqr.dart';
import 'package:dpc_flutter/Pages/chooseDamageCar.dart';
...
class ConfirmeChooseCar extends StatefulWidget {
  final Car car;
  const ConfirmeChooseCar({super.key, required this.car});

  @override
  State<ConfirmeChooseCar> createState() => _ConfirmeChooseCarState();
}

class _ConfirmeChooseCarState extends State<ConfirmeChooseCar> {
  String token = "";
                      ...
                      Column(
                        children: [
                          Visibility(
                            ...
                            child: QrImageView(
                              data:
                                  '${widget.car.carId}-${insuranceId}-${userId}',
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              ...
                              child: TextButton(
                                  onPressed: () {
                                    saveData("CarIdDamagedCar",
                                        widget.car.carId.toString());
                                    saveData("insuranceIdDamagedCar",
