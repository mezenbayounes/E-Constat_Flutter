...
class CarDamageA extends StatefulWidget {
  const CarDamageA({super.key});

  @override
  State<CarDamageA> createState() => _CarDamageAState();
}

class _CarDamageAState extends State<CarDamageA> {
  String token = "";
...
//////////////
  ...
  void accidant(BuildContext context) {
    Navigator.pushNamed(context, '/CarDamageB');
  }
            ...
            Container(
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage(
                      'lib/images/backgounda.png'), // Replace with your background image path
                  fit: BoxFit.cover,
                ),
              ),
            ),
